...
import { ArrowLeft, FileText, Calendar, Building, DollarSign, User } from 'lucide-react';
...
export default async function AdminRequestDetailPage({
  ...
  const profile = request.profiles as { full_name: string; email: string } | null;
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="flex items-start justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Revisar Solicitud</h1>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6 mb-6">
        <h2 className="font-semibold text-gray-900 mb-4">Solicitante</h2>
      ...
      <div className="bg-indigo-50 rounded-xl border border-indigo-200 p-6 mb-6">
        ...
        <div className="grid grid-cols-3 gap-4 text-center">
          ...
          <div>
            <p className="text-xs text-indigo-600 mb-1">Pago del Usuario</p>
